    ...
    public class layout
    {
        ...
        private static void TelaBoasVindas(Pessoa pessoa)
        {
            string msgTelaBemVindo =
                $"{pessoa.Nome} | Conta: {pessoa.Conta.GetCodigoDoBanco()} | Agência:  {pessoa.Conta.GetNumeroAgencia()} | Conta: {pessoa.Conta.GetNumeroDaConta()}";
            Console.WriteLine("");
        ...
        private static void TelaSaque(Pessoa pessoa)
        {
           ...
           bool okSaque =  pessoa.Conta.Saca(valor);
            ...
            Console.WriteLine("             ==============================        ");
                ...
                Console.WriteLine("             Saque Realizado sem sucesso        ");
                Console.WriteLine("             ==============================     ");
            }
